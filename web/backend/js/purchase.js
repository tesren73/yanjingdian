				...
				afterSaveCell: function(a, c, d, e, f) {
					...
					case "qty":
						var d = parseFloat(d),
							...
							h = parseFloat($("#grid").jqGrid("getCell", a, f + 4));
		...
		addEvent: function() {
			...
			this.$_date.bind("keydown", function(a) {
				...
				if (a.preventDefault(), Business.verifyRight("PU_ADD")) {
					var b = "进货单",
						c = "purchase-purchase";
					if ("150502" == originalData.transType) var b = "进货退货单",
