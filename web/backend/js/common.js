...
Public.gotoDetailItem = function(params){
	...
	var urls = {
		//SALE
		'150601' : {tabid : 'sales-sales',text : '配镜单',right:'SA_QUERY', url : '/sales/sales.jsp?id='},
		//SALEBACK
		'150602' : {tabid : 'sales-salesBack',text : '配镜退货单',right:'SA_QUERY', url : '/sales/sales.jsp?transType=150602&id='},
		//PUR
		'150501' : {tabid : 'purchase-purchase',text : '进货单',right:'PU_QUERY',url : '/purchase/purchase.jsp?id='},
		//PUR
		'150502' : {tabid : 'purchase-purchaseBack',text : '进货退货单',right:'PU_QUERY',url : '/purchase/purchase.jsp?transType=150502&id='},
		//TRANSFER
